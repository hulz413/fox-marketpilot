...
READINESS_STAGE_VALUES = [
    *CRITICAL_STAGE_VALUES,
    ...
    ResearchTaskStage.ANALYZE_RESEARCH.value,
    ...
    ResearchTaskStage.SYNTHESIZE_RESEARCH_FINDINGS.value,
...
STAGE_LABELS = {
    ...
    ResearchTaskStage.SYNTHESIZE_RESEARCH_FINDINGS.value: "汇总研究发现",
